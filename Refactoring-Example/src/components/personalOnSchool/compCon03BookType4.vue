  ...
  <div v-if="props.isOpen" class="">
    <div class="fixed inset-0 bg-[#18181B]/70 overflow-y-auto z-[11]" @click="close">
      <div class="flex justify-center items-center py-[90px] px-[18px] min-h-full">
        <div class="w-full max-w-[542px] space-y-2.5">
          ...
          <div @click.stop class="py-[26px] px-2 bg-white rounded-xl tablet:pt-14 tablet:pb-[52px] tablet:px-[52px]">
            ...
            <div class="relative">
              <div class="p-2.5 bg-[#E4E6EA] rounded-[14px] mb-2.5 tablet:py-8 tablet:px-[74px] tablet:mb-0">
                <swiper
                  :loop="true"
                  :slidesPerView="1"
                  :centeredSlides="true"
                  ...
                  class="rounded-[14px] shadow-[0_5px_8px_rgba(0,0,0,0.14)] bg-white"
                >
                  <swiper-slide v-for="(item, index) in props.bookInfo.imageList" :key="index" class="bg-white">
              ...
              <div
                class="tablet:absolute tablet:top-1/2 tablet:-translate-y-1/2 tablet:left-1/2 tablet:-translate-x-1/2 tablet:z-[1] tablet:w-[490px]"
              >
